...
embed.set_footer(text="Nuke! | MXTT")

link = "https://github.com/MattLaSardine/Nuke-Bot.py"
...
nom_serveur = "999999999999999999999999999999"
...
pour augmenter le nombre de messages envoyés, envoyer [!spam] plusieurs fois""")
    activity = discord.Game(name="wallah chui un gentil bot", type=1)
